...
$.dore = function (element, options) {
    ...
    function init() {
        ...
        if (typeof Chart !== "undefined") {
            ...
            if (document.getElementById("totalAppointmentChart")) {
                var totalAppointmentChart = document.getElementById("totalAppointmentChart").getContext("2d");
                var myChart = new Chart(totalAppointmentChart, {
                    type: "LineWithShadow",
                    options: {
                        plugins: {
                            datalabels: {
        ...
        if (typeof Quill !== "undefined") {
            ...
            var editor = new Quill("#quillEditorProductDescInEng", {
                modules: {toolbar: quillToolbarOptions},
                theme: "snow"
            });


            var editor = new Quill("#quillEditorProductDescInAr", {
                modules: {toolbar: quillToolbarOptions},
                theme: "snow"
            });
